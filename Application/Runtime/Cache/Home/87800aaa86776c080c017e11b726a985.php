...
<head>
  ...
  <link href="/Public/Css/Camp/index.css" rel="stylesheet">	
...
<nav class="navbar navbar-inverse">
  <div class="container">
    ...
    <div class="container">
        <div class="des">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="info" style="background-image: url('/Public/campimgs/<?php echo ($vo["savename"]); ?>');background-size: 100% 100%;height:500px">
                        <div class="name"><?php echo ($vo["name"]); ?></div>
                        <div class="campdes"><?php echo ($vo["des"]); ?></div>
                </div>
                <div style="margin-top:10px">
                    <a class="btn btn-info" href="<?php echo U('Home/Manager/changeFuture');?>?id=<?php echo ($vo["id"]); ?>">设为预期活动</a>
                    <a class="btn btn-warning" href="<?php echo U('Home/Manager/deleteCamp');?>?id=<?php echo ($vo["id"]); ?>" style="float:right">删除</a> 
                </div>
