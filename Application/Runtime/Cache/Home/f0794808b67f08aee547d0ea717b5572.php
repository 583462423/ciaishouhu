...
<nav class="navbar navbar-inverse">
  <div class="container">
    ...
    <div class="container">
        <div class="des">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="info row">
                    <img class="img col-md-4" src="/Public/starimgs/<?php echo ($vo["savename"]); ?>"/>
                    <div class="right col-md-8">
                        <span style="background-color: #E81D62;padding:10px;color:white;margin-left: -15px;font-size: 18px;float:left">人物介绍</span>
                        <p class="name" style="clear: both"><b><?php echo ($vo["name"]); ?></b></p>
                        <p class="desc"><?php echo ($vo["des"]); ?></p>
                    </div>
                </div>
