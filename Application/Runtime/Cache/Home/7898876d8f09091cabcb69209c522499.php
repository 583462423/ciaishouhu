    ...
    <div class="collapse navbar-collapse" id="header-nav">
      ...
      <ul class="nav navbar-nav right-nav">
        ...
        <div class="container" style="height:700px">
                ...
                <p>以下是您发表过的帖子</p>
                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "暂时没有发过帖子" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Home/Forum/foruminfo');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "暂时没有发过帖子" ;endif; ?>
