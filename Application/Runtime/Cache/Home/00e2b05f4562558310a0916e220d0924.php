    ...
    <div class="container">
        <div class="des">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="info col-md-6">
                    <img class="img-thumbnail" src="/Public/pictures/<?php echo ($vo["savename"]); ?>" style="height:400px;width:100%">
                    <p><?php echo ($vo["des"]); ?><span style="float:right"><?php echo ($vo["uploaddate"]); ?></span></p>
                    <a class="btn btn-warning" style="width:100%;"href="<?php echo U('Home/Manager/deletePic');?>?id=<?php echo ($vo["id"]); ?>">删除</a>
