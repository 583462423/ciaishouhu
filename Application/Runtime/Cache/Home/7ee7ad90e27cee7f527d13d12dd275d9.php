...
<div class="container" style="height:600px">
  <div class="btns">
    <a class="active" href="<?php echo U('Home/Teach/smallcourse');?>">小学</a>
    <a class="noactive" href="<?php echo U('Home/Teach/middlecourse');?>">初中</a>
  </div>

      <ul class="smasch">
       <?php if(is_array($small_list)): $i = 0; $__LIST__ = $small_list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["booklink"]); ?>"><span class="course_title"><?php echo ($vo["subject"]); ?></span><?php echo ($vo["grade"]); ?>--------<?php echo ($vo["bookname"]); ?></a></li><?php endforeach; endif; else: echo "暂时没有数据" ;endif; ?>
      </ul>
