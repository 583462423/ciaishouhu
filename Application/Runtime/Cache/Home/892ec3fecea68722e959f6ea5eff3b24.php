...
<div class="main_panel">
	...
	<div class="login_logo">
		...
		<p style="font-family: '微软雅黑';font-size: 20px;color:#ccc">管理员请登录</p>
	</div>
	<div class="login_panel">
		
			<form class="form-horizontal login_form" id="loginForm" role="form" action="<?php echo U('Home/Manager/testLogin');?>">
	...
	<p class="super_link"><a href="<?php echo U('Home/Index/main');?>">首页</a>
</div>
		    ...
		    $('#loginForm')
                ...
                .on('success.form.bv', function(e) {
                    ...
                    $.post($form.attr('action'), $form.serialize(), function(result) {
                        if(result == 1){
                            window.location.href="/index.php/Home/Manager/manager";
                        }
                        else{
                            alert(result);
                            $('.password').val('');
