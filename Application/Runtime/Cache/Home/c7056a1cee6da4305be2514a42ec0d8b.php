...
<div class="container" style="height:600px">
      ...
      <ul class="smasch">
       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["booklink"]); ?>"><?php echo ($vo["bookname"]); ?></a>
              <a href="<?php echo U('Home/Manager/delete');?>?id=<?php echo ($vo["id"]); ?>" class="btn btn-warning" style="float:right">删除</a>
