...
<div style="height:700px;">
    <div class="upload">
        <form class="form-horizontal" id="uploadForm" enctype="multipart/form-data" role="form" method="post" action="<?php echo U('Home/Manager/upload');?>">
            <div class="form-group">
              <label  class="col-xs-2 control-label">照片上传</label>
              <input id="lefile" class="col-xs-2" type="file" name="starimg" style="display:none">
