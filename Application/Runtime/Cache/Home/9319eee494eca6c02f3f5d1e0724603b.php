...
<nav class="navbar navbar-inverse">
  <div class="container">
    ...
    <div class="container">
        ...
        <div class="des_head">
            <h2 style="color:red">预期活动</h2>
            <p style="font-size:20px;float:left"><strong>REVIEW</strong></p><div style="background-color: black;width:40px;height:16px;display: inline-block;margin-top: 6px;"></div>
        </div>
        <hr>
        ...
        <div class="des">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="info">
                        ...
                        <img src="/Public/campimgs/<?php echo ($vo["savename"]); ?>" style="width: 100%;border-radius: 10px;" />
                </div>
