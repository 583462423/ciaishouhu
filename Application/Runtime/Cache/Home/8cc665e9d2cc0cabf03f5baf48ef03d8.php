      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo U('Home/Teach/course');?>">课件精选</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="#">远程教育</a></li>
          </ul>
        </li>
...
<div class="container" style="height:800px">
      ...
      <ul class="smasch">
       <?php if(is_array($small_list)): $i = 0; $__LIST__ = $small_list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["booklink"]); ?>"><?php echo ($vo["bookname"]); ?></a></li><?php endforeach; endif; else: echo "暂时没有数据" ;endif; ?>
      </ul>
      <div style="clear:both;text-align: center;position: relative;top:30px"><?php echo ($small_page); ?></div>
	...
	<div class="myContainer">
		...
		<div class="footerInfor row">
			...
			<div class="footeritem info2 col-md-4">
				...
				<hr>
					<ul>
						<li><a href="http://www.chinadolls.org.cn/">瓷娃娃罕见病关爱中心</a></li>
						<li><a href="http://weihai.sddpf.org.cn">威海市残疾人联合会</a></li>
						<li><a href="http://www.qdpf.org.cn/index.htm">青岛市残疾人联合会</a></li>
						<li><a href="http://ytcl.yantai.gov.cn/web/Index.aspx">烟台残疾人联合会</a></li>
					</ul>
			</div>
